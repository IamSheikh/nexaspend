...
const DeleteTransactionAccountModal = ({
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 max-w-md">
        ...
        <div className="flex justify-end mt-2">
          <button
            ...
            onClick={() => {
              setIsDeleteTransactionAccountModalOpen(false);
          ...
          <button
            ...
            onClick={async () => {
              await window.electron.deleteTransactionAccount(
                selectedTransactionAccount?.id as number,
              );
              toast('Account Successfully deleted', {
                type: 'error',
              });
              setIsDeleteTransactionAccountModalOpen(false);
              setIsDeleteTransactionAccountModalOpen(undefined);
...
export default DeleteTransactionAccountModal;
